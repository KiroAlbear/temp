...
class BalanceRemote extends BaseRemoteModule<BalanceMapper, BalanceResponse> {
  BalanceRemote() {
  ...
  @override
  ApiState<BalanceMapper> onSuccessHandle(BalanceResponse? response) {
    return SuccessState(BalanceMapper(response!));
  }
