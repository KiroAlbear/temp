...
#if __has_include(<dio_builder/DioBuilderPlugin.h>)
#import <dio_builder/DioBuilderPlugin.h>
#else
@import dio_builder;
#endif
...
#if __has_include(<transition_easy/TransitionEasyPlugin.h>)
#import <transition_easy/TransitionEasyPlugin.h>
#else
...
+ (void)registerWithRegistry:(NSObject<FlutterPluginRegistry>*)registry {
  ...
  [DioBuilderPlugin registerWithRegistrar:[registry registrarForPlugin:@"DioBuilderPlugin"]];
  ...
  [TransitionEasyPlugin registerWithRegistrar:[registry registrarForPlugin:@"TransitionEasyPlugin"]];
