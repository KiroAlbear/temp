...
class _ChangePasswordWidgetState extends BaseState<ResetPasswordPage> {
    ...
    child: Padding(
      ...
      child: Column(
        ...
        children: [
          Center(
            child: CustomText(
              text: Loc.of(context)!.resetPassword,
  ...
  Widget get _confirmPasswordFiled => CustomTextFormFiled(
    onChanged: (value) {
      ...
      widget.forgetPasswordBloc.confirmPasswordBloc.updateStringBehaviour(
        value,
      );
    },
    textFiledControllerStream:
