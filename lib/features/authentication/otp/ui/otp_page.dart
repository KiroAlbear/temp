...
class _OtpWidgetState extends BaseState<OtpPage> {
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  Center(
                    child: CustomText(
                      text: Loc.of(context)!.enterVerificationCode,
  ...
  void _addCodeToBloc(String text) {
    _bloc.otpBloc.textFormFiledBehaviour.sink.add(
  ...
  String enterVerificationCodeSentTo(Object codeLength, Object mobileNumber) {
    return '${Loc.of(context)!.enter} ${Loc.of(context)!.the} $codeLength ${Loc.of(context)!.numberSentTo} $mobileNumber';
  }
      ...
      builder: (context, timeSnapShot) => Column(
        ...
        children: [
          InkWell(
            ...
            child: CustomText(
              text: Loc.of(context)!.sendOtpAgain,
  ...
  Widget get _button => CustomButtonWidget(
    idleText: Loc.of(context)!.otpAuthenticate,
    onTap: () {
