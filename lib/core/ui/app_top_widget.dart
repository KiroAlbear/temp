...
class _AppTopWidgetState extends State<AppTopWidget> {
  ...
  Widget get _topStack => Container(
        ...
        child: Column(
          children: [
            ...
            17.verticalSpace,
            if (widget.isHavingSearch) ...[_searchWidget] else ...[
              Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  _titleRow,
  ...
  Widget get _supportWidget => widget.isHavingSupport == false?SizedBox():InkWell(
  ...
  Widget get _logoWidget => widget.isHavingHomeLogo == false?SizedBox():ImageHelper(
  ...
  Widget get _searchWidget => SizedBox(
    ...
    child: CustomTextFormFiled(
      ...
      textLabelColor: disabledButtonTextColorLightMode,
